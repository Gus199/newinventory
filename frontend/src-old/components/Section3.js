    ...
    <section className='sec about' id='services'>
      <div className='content'>
        <div className='mxw800p'>
          <h3>User Guide</h3>
          <p>
            This Application inventory management Allow you to Manage your Store
            in one place, track product, adding new ones, update and add notes
          </p>
        </div>
        <div className='services'>
          ...
          <div className='box'>
            ...
            <div className='content'>
              ...
              <p>View all Products added by this User and latest updates</p>
            </div>
          </div>
          <div className='box'>
            <div className='iconBx'>
            ...
            <div className='content'>
              ...
              <p>
                View All Products with More dteails , descriptions, Inventory
                numbers, Types, and created dates
              </p>
            </div>
          </div>
          <div className='box'>
